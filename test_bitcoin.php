...
<body>
<?php
$sys=new BitcoinSystem('http://rpcuser:password@localhost:8332');
?>
...
<?php
$bc=new BitcoinAccount('http://rpcuser:password@localhost:8332');
?>
...
<?php
$tt=new BitcoinUser('http://rpcuser:password@localhost:8332');
?>
